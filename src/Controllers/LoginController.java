    ...
    private void authentification(ActionEvent event) throws IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                ServiceUser su = new ServiceUser();
                UserSession z = UserSession.getInstance(su.getByEmail(mail));
                System.out.println(z.getU());

                Parent globalPane = FXMLLoader.load(getClass().getResource("/HomePageHolder.fxml"));
